...
void serial_run(float m_member, float m_insert, float m_delete, struct list_node **head, int m) {

    int member_operations = (int) (m_member * m);
    int insert_operations = (int) (m_insert * m);
    int delete_operations = (int) (m_delete * m);
    ...
    while (total_operations_count < m) {
        ...
        else if (rand_operation == 1 && insert_operations_count < insert_operations) {
